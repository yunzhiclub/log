...
describe('BackgroundIndexComponent', () => {
  ...
  it('当前页、总页数、每页大小', () => {
    ...
    /* 断言绑定了C层的分页值 */
    expect(text).toContain(`第${component.params.page}/${component.logPage.totalPages}页`);
  ...
  it('下一页(尾页）样式', () => {
    ...
    cssSelector.forEach((value) => {
      ...
      component.logPage.totalPages = 4;
      fixture.detectChanges();
      ...
      /* 总页数为3页，下一页（尾页)不可点击 */
      component.logPage.totalPages = 3;
      fixture.detectChanges();
  ...
  it('点击尾页', () => {
    ...
    spyOn(component, 'onPage');
    liElement.click();
    expect(component.onPage).toHaveBeenCalledWith(component.logPage.totalPages - 1);
  });
});
