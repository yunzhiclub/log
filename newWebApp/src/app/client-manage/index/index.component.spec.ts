...
describe('Client->Index', () => {
  ...
  it('当前页、总页数、每页大小', () => {
    ...
    /* 断言绑定了C层的分页值 */
    expect(text).toContain(`第${component.params.page}/${component.clientPage.totalPages}页`);
  ...
  it('下一页(尾页）样式', () => {
    ...
    cssSelector.forEach((value) => {
      ...
      component.clientPage.totalPages = 4;
      fixture.detectChanges();
      ...
      /* 总页数为3页，下一页（尾页)不可点击 */
      component.clientPage.totalPages = 3;
      fixture.detectChanges();
  ...
  it('点击尾页', () => {
    ...
    spyOn(component, 'onPage');
    liElement.click();
    expect(component.onPage).toHaveBeenCalledWith(component.clientPage.totalPages - 1);
  });
});
