...
export class LogService {
   ...
   * @param param 查询参数
   */
  public page(page: number, size: number, param: { clientName?: string}): Observable<Page<Log>> {
    const httpParams = new HttpParams()
      .append('page', page.toString())
      .append('size', size.toString())
      .append('clientName', isNotNullOrUndefined(param.clientName) ? param.clientName.toString() : '')
